...
echo -e "\e[1;32m🧬 Building mathchain-secret-store-$1-x86_64-linux-gnu-glibc-2.17-llvm-3.8 \e[0m"
...
# rm mathchain
cp ../target/x86_64-unknown-linux-gnu/release/parity-secretstore-substrate ./mathchain-secret-store
tar cjSf mathchain-secret-store-$1-x86_64-linux-gnu-glibc-2.17-llvm-3.8.tar.bz2 mathchain-secret-store
rm mathchain-secret-store
